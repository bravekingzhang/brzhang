<template>
    <div id="app" class="">
        <div data-v-ad5d153c="" class="headerWrapper">
            <header data-v-ad5d153c="" class="header">
                <div data-v-ad5d153c="" class="container"><h1 data-v-ad5d153c=""><a
                        data-v-ad5d153c=""  class="router-link-active">brzhang.club</a></h1>
                    <ul data-v-ad5d153c="" class="nav">
                        <li data-v-ad5d153c="" class="nav-item"><a data-v-ad5d153c=""
                                                                   href="#"
                                                                   class="active">主页
                        </a></li>
                        <li data-v-ad5d153c="" class="nav-item"><a data-v-ad5d153c=""
                                                                   href="https://blog.brzhang.club/"
                                                                   class="">我的博客
                        </a></li>
                        <li data-v-ad5d153c="" class="nav-item"><a data-v-ad5d153c=""
                                                                                  href="https://cloud.tencent.com/developer/user/1203298"
                                                                                  class="">我的腾讯云</a>
                        </li>
                        <li data-v-ad5d153c="" class="nav-item"><a data-v-ad5d153c=""
                                                                   href="https://github.com/bravekingzhang" class="">我的github
                        </a></li>
                    </ul>
                </div>
            </header>
        ...
        <div class="main-cnt">
            <div class="page-container page-guide">
                <div class="el-row">
                    ...
                    <div class="el-col el-col-24 el-col-xs-24 el-col-sm-19">
                        <div data-v-7aed89bc="" class="content">
                            <div data-v-7aed89bc="" class="cards el-row"
                                 style="margin-left: -7px; margin-right: -7px;">
                                <div data-v-7aed89bc=""
                                     class="el-col el-col-24 el-col-xs-12 el-col-sm-6"
                                     style="padding-left: 7px; padding-right: 7px;">
                                    <div data-v-7aed89bc="" class="card"><ChangTouChat :temperature="temperature" :date="date"></ChangTouChat>
                                        <span>中证50</span>
                                    </div>
                                </div>
                                <div data-v-7aed89bc=""
        ...
        <footer class="footer">
            <div class="container">
                <div class="footer-main"><h4>关于</h4><a href="http://beian.miit.gov.cn/"
                                                       target="_blank"
                                                       class="footer-main-link">粤ICP备19057760号</a></div>
                <div class="footer-social"><p class="footer-social-title">brzhang.club</p>
                    <span><div role="tooltip" id="el-popover-5554" aria-hidden="true"
                               class="el-popover el-popper footer-popover" tabindex="0"
                               style="width: 120px; display: none;"><!----><div
                            class="footer-popover-title">饿了么 UED</div><img
                            src="static/qrcode.a88f522.png" alt=""></div></span><i
                            class="doc-icon-weixin elementdoc el-popover__reference"
                            aria-describedby="el-popover-5554" tabindex="0"></i><a
                            href="https://github.com/elemefe" target="_blank"><i
                            class="doc-icon-github elementdoc"></i></a><a
                            href="https://gitter.im/ElemeFE/element" target="_blank"><i
                            class="doc-icon-gitter elementdoc"></i></a></div>
            </div>
        </footer>
    </div>
</template>
...
<style>
    ...
    .headerWrapper[data-v-ad5d153c] {
        height: 80px
    }

    .header[data-v-ad5d153c] {
        height: 80px;
        background-color: #fff;
        color: #fff;
        top: 0;
    ...
    .header h1 a[data-v-ad5d153c] {
        color: #333;
        text-decoration: none;
        display: block
    }

    .header h1 span[data-v-ad5d153c] {
        font-size: 12px;
        display: inline-block;
        width: 34px;
        height: 18px;
    ...
    .header .nav[data-v-ad5d153c]:after, .header .nav[data-v-ad5d153c]:before {
        display: table;
        content: ""
    }

    .header .nav[data-v-ad5d153c]:after {
        clear: both
    }

    .header .nav-gap[data-v-ad5d153c] {
        position: relative;
        width: 1px;
        height: 80px;
        padding: 0 20px
    ...
    .header .nav-gap[data-v-ad5d153c]:before {
        content: "";
        position: absolute;
        top: calc(50% - 8px);
        width: 1px;
    ...
    .header .nav-logo-small[data-v-ad5d153c], .header .nav-logo[data-v-ad5d153c] {
        vertical-align: sub
    }

    .header .nav-logo-small[data-v-ad5d153c] {
        display: none
    }

    .header .nav-item[data-v-ad5d153c] {
        margin: 0;
        float: left;
        list-style: none;
        position: relative;
    ...
    .header .nav-item.nav-algolia-search[data-v-ad5d153c] {
        cursor: default
    }

    .header .nav-item.lang-item[data-v-ad5d153c], .header .nav-item[data-v-ad5d153c]:last-child {
        cursor: default;
        margin-left: 34px
    }

    .header .nav-item.lang-item span[data-v-ad5d153c], .header .nav-item:last-child span[data-v-ad5d153c] {
        opacity: .8
    }

    .header .nav-item.lang-item .nav-lang[data-v-ad5d153c], .header .nav-item:last-child .nav-lang[data-v-ad5d153c] {
        cursor: pointer;
        display: inline-block;
        height: 100%;
        color: #888
    ...
    .header .nav-item.lang-item .nav-lang[data-v-ad5d153c]:hover, .header .nav-item:last-child .nav-lang[data-v-ad5d153c]:hover {
        color: #409eff
    }

    .header .nav-item.lang-item .nav-lang.active[data-v-ad5d153c], .header .nav-item:last-child .nav-lang.active[data-v-ad5d153c] {
        font-weight: 700;
        color: #409eff
    }

    .header .nav-item a[data-v-ad5d153c] {
        text-decoration: none;
        color: #1989fa;
        opacity: .5;
        display: block;
    ...
    .header .nav-item a.active[data-v-ad5d153c], .header .nav-item a[data-v-ad5d153c]:hover {
        opacity: 1
    }

    .header .nav-item a.active[data-v-ad5d153c]:after {
        content: "";
        display: inline-block;
        position: absolute;
        bottom: 0;
    ...
    .nav-dropdown[data-v-ad5d153c] {
        margin-bottom: 6px;
        padding-left: 18px;
        width: 100%
    }

    .nav-dropdown span[data-v-ad5d153c] {
        display: block;
        width: 100%;
        font-size: 16px;
        color: #888;
    ...
    .nav-dropdown span[data-v-ad5d153c]:hover {
        cursor: pointer
    }

    .nav-dropdown i[data-v-ad5d153c] {
        transition: .2s;
        font-size: 12px;
        color: #979797;
    ...
    .nav-dropdown .is-active i[data-v-ad5d153c], .nav-dropdown .is-active span[data-v-ad5d153c] {
        color: #409eff
    }

    .nav-dropdown .is-active i[data-v-ad5d153c] {
        transform: rotate(180deg) translateY(3px)
    }

    .nav-dropdown:hover i[data-v-ad5d153c], .nav-dropdown:hover span[data-v-ad5d153c] {
        color: #409eff
    }

    .nav-dropdown-list[data-v-ad5d153c] {
        width: auto
    }

    @media (max-width: 850px) {
        .header .nav-logo[data-v-ad5d153c] {
            display: none
        }
        ...
        .header .nav-algolia-search[data-v-ad5d153c], .header .nav-theme-switch[data-v-ad5d153c] {
            display: none
        }
    }
    ...
    @media (max-width: 700px) {
        ...
        .header .nav-item.lang-item[data-v-ad5d153c] {
            height: 100%
        }

        .header .nav-item.lang-item .nav-lang[data-v-ad5d153c] {
            display: flex;
            align-items: center
        }

        .header .nav-item.lang-item .nav-lang span[data-v-ad5d153c] {
            padding-bottom: 0
        }

        .header .nav-dropdown[data-v-ad5d153c] {
            padding: 0
        }

        .header .nav-dropdown span[data-v-ad5d153c] {
            font-size: 12px
        }
        ...
        .header .nav-versions[data-v-ad5d153c] {
            display: none
        }
    }
    ...
    .footer-nav, .nav-dropdown-list li {
        font-size: 14px
    }
    ...
    .demo-block .avatar-uploader .el-upload:focus, .demo-block .avatar-uploader .el-upload:hover {
        border-color: #409eff
    }
    ...
    .demo-image .block:last-child, .demo-image__error .block:last-child, .demo-image__placeholder .block:last-child {
        border-right: none
    }
    ...
    .banner[data-v-f0b2f288] {
        text-align: center
    }

    .banner-desc[data-v-f0b2f288] {
        padding-top: 20px
    }

    .banner-desc h1[data-v-f0b2f288] {
        font-size: 34px;
        margin: 0;
        line-height: 48px;
        color: #555
    ...
    .sponsors[data-v-f0b2f288] {
        display: flex;
        justify-content: center
    }

    .sponsor[data-v-f0b2f288] {
        margin: 0 20px 50px;
        display: inline-flex;
        width: 300px;
        height: 100px;
    ...
    .sponsor img[data-v-f0b2f288] {
        margin-right: 20px
    }

    .sponsor div[data-v-f0b2f288] {
        display: flex;
        flex-direction: column;
        justify-content: center
    }

    .sponsor p[data-v-f0b2f288] {
        margin: 0;
        line-height: 1.8;
        color: #999;
        font-size: 14px
    ...
    .jumbotron[data-v-f0b2f288] {
        width: 890px;
        margin: 30px auto;
        position: relative
    }

    .jumbotron img[data-v-f0b2f288] {
        width: 100%
    }

    .jumbotron .jumbotron-red[data-v-f0b2f288] {
    ...
    .cards[data-v-f0b2f288] {
        margin: 0 auto 110px;
        width: 1140px
    }

    .cards .container[data-v-f0b2f288] {
        padding: 0;
        margin: 0 -11px;
        width: auto
    }

    .cards .container[data-v-f0b2f288]:after, .cards .container[data-v-f0b2f288]:before {
        display: table;
        content: ""
    }

    .cards .container[data-v-f0b2f288]:after {
        clear: both
    }

    .cards li[data-v-f0b2f288] {
        width: 25%;
        padding: 0 19px;
        box-sizing: border-box;
        float: left;
    ...
    .cards img[data-v-f0b2f288] {
        width: 160px;
        height: 120px
    }

    .card[data-v-f0b2f288] {
        height: 430px;
        width: 100%;
        background: #fff;
        border: 1px solid #eaeefb;
    ...
    .card img[data-v-f0b2f288] {
        margin: 66px auto 60px
    }

    .card h3[data-v-f0b2f288] {
        margin: 0;
        font-size: 18px;
        color: #1f2f3d;
        font-weight: 400
    ...
    .card a[data-v-f0b2f288]:hover {
        color: #fff;
        background: #409eff
    }

    .card[data-v-f0b2f288]:hover {
        bottom: 6px;
    ...
    @media (max-width: 1140px) {
        ...
        .banner .container[data-v-f0b2f288] {
            width: 100%;
            box-sizing: border-box
        }

        .banner img[data-v-f0b2f288] {
            right: 0
        }
    }

    @media (max-width: 1000px) {
        .banner .container img[data-v-f0b2f288], .jumbotron[data-v-f0b2f288] {
            display: none
        }
    }
    ...
    @media (max-width: 768px) {
        ...
        .cards .card[data-v-f0b2f288] {
            height: auto;
            padding-bottom: 54px
        }

        .banner-desc #line2[data-v-f0b2f288], .banner-stars[data-v-f0b2f288] {
            display: none
        }

        .banner-desc h2[data-v-f0b2f288] {
            font-size: 32px
        }
    ...
    .theme-intro-b .intro-banner[data-v-f0b2f288] {
        position: absolute
    }

    .theme-intro-b img[data-v-f0b2f288] {
        width: 300px
    }

    .theme-intro-b .title[data-v-f0b2f288] {
        position: absolute;
        top: 0;
        bottom: 0;
        left: 0;
    ...
    .theme-intro-b .title p[data-v-f0b2f288] {
        padding: 0;
        margin: 10px 0
    }

    .theme-intro-a[data-v-f0b2f288] {
        position: fixed;
        left: 0;
        right: 0;
        top: 0;
    ...
    .theme-intro-a .mask[data-v-f0b2f288] {
        position: fixed;
        left: 0;
        right: 0;
        top: 0;
    ...
    .theme-intro-a .intro-banner[data-v-f0b2f288] {
        top: 50%;
        left: 50%;
        position: fixed;
    ...
    .theme-intro-a .intro-banner img[data-v-f0b2f288] {
        width: 100%
    }

    .theme-intro-a .intro-banner .intro-text[data-v-f0b2f288] {
        position: absolute;
        top: 50%;
        left: 0;
        right: 0
    ...
    .theme-intro-a .intro-banner .intro-text p[data-v-f0b2f288] {
        padding: 0;
        margin: 0;
        font-size: 48px;
        font-weight: 700;
